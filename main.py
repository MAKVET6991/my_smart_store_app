...
def get_file_limit(uploaded_file):
...
st.success(
"Admin لديه استخدام كامل بدون حد للرسائل أو رفع الملفات داخل التطبيق."
)
...
st.info(
f"🎁 التجربة المجانية — متبقي {remaining} يوم."
)
...
allowed, size_error = check_file_size(
uploaded_file
)
